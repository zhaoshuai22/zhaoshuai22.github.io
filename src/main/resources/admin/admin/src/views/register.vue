    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">大学生创新创业项目管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="教师名称" class="input" v-if="tableName=='jiaoshi'">
                            <el-input v-model="ruleForm.jiaoshiName" autocomplete="off" placeholder="教师名称"  />
                        </el-form-item>
                        ...
                        <!--
                            ...
                            <el-form-item label="教师头像" class="input" v-if="tableName=='jiaoshi'">
                                    <file-upload
                                        tip="点击上传教师头像"
                                        action="file/upload"
                                        :limit="1"
                        ...
                        <el-form-item label="教师邮箱" class="input" v-if="tableName=='jiaoshi'">
                            <el-input v-model="ruleForm.jiaoshiEmail" autocomplete="off" placeholder="教师邮箱"  />
                        </el-form-item>
                        <!--
                            <el-form-item label="逻辑删除" class="input" v-if="tableName=='jiaoshi'">
                                <el-input v-model="ruleForm.jiaoshiDelete" autocomplete="off" placeholder="逻辑删除"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="入职时间" class="input" v-if="tableName=='jiaoshi'">
                                <el-input v-model="ruleForm.jiaoshiTime" autocomplete="off" placeholder="入职时间"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="添加时间" class="input" v-if="tableName=='jiaoshi'">
                        ...
                        -->
                        <!--
                            <el-form-item label="入职时间" class="input" v-if="tableName=='yonghu'">
                                <el-input v-model="ruleForm.yonghuTime" autocomplete="off" placeholder="入职时间"  />
                           </el-form-item>
                        -->
                        <!--
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            // jiaoshi 中的 逻辑删除 判空处理
                            // if('jiaoshi' == this.tableName && (this.ruleForm.jiaoshiDelete== null ||this.ruleForm.jiaoshiDelete== "")){
                            //     this.$message.error("逻辑删除不能为空");
                            //     return
                            // }
                            // jiaoshi 中的 入职时间 判空处理
                            // if('jiaoshi' == this.tableName && (this.ruleForm.jiaoshiTime== null ||this.ruleForm.jiaoshiTime== "")){
                            //     this.$message.error("入职时间不能为空");
                            //     return
                            // }
                            // jiaoshi 中的 添加时间 判空处理
                            // if('jiaoshi' == this.tableName && (this.ruleForm.insertTime== null ||this.ruleForm.insertTime== "")){
                            ...
                            // }
                            // yonghu 中的 入职时间 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.yonghuTime== null ||this.ruleForm.yonghuTime== "")){
                            //     this.$message.error("入职时间不能为空");
                            //     return
                            // }
                            // yonghu 中的 添加时间 判空处理
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/daxueshengcycxin/img/back-img-bg.jpg);
