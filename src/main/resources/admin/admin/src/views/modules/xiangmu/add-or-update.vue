    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='jiaoshi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="教师名称" prop="jiaoshiName">
                        <el-input v-model="jiaoshiForm.jiaoshiName"
                                  placeholder="教师名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="教师名称" prop="jiaoshiName">
                            <el-input v-model="ruleForm.jiaoshiName"
                                      placeholder="教师名称" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='jiaoshi' ">
                ...
                <el-col :span="12"  v-if="sessionTable !='jiaoshi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="教师邮箱" prop="jiaoshiEmail">
                        <el-input v-model="jiaoshiForm.jiaoshiEmail"
                                  placeholder="教师邮箱" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="教师邮箱" prop="jiaoshiEmail">
                ...
                <el-col :span="12"  v-if="sessionTable !='jiaoshi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="入职时间" prop="jiaoshiTime">
                        <el-input v-model="jiaoshiForm.jiaoshiTime"
                                  placeholder="入职时间" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="入职时间" prop="jiaoshiTime">
                            <el-input v-model="ruleForm.jiaoshiTime"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="项目经费" prop="xiangmuJingfei">
                       <el-input v-model="ruleForm.xiangmuJingfei"
                                 placeholder="项目经费" clearable  :readonly="ro.xiangmuJingfei"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.xiangmuFile" label="项目文件" prop="xiangmuFile">
                        <file-upload
                                tip="点击上传项目文件"
                                action="file/upload"
                                :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.xiangmuFile" label="项目文件" prop="xiangmuFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.xiangmuFile"  >项目文件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="项目创新点" prop="xiangmuChuangxin">
                       <el-input v-model="ruleForm.xiangmuChuangxin"
                                 placeholder="项目创新点" clearable  :readonly="ro.xiangmuChuangxin"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="项目实施方案" prop="xiangmuText">
                        <el-input type="textarea"  :readonly="ro.xiangmuText" v-model="ruleForm.xiangmuText" placeholder="项目实施方案"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xiangmuText" label="项目实施方案" prop="xiangmuText">
                            <span v-html="ruleForm.xiangmuText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.xiangmuContent"  label="项目详情" prop="xiangmuContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xiangmuContent" label="项目详情" prop="xiangmuContent">
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.xiangmuYesnoTypes" label="申报状态" prop="xiangmuYesnoTypes">
                        <el-input v-model="ruleForm.xiangmuYesnoValue" placeholder="申报状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.xiangmuYesnoText" label="申报结果" prop="xiangmuYesnoText">
                        <span v-html="ruleForm.xiangmuYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                jiaoshiForm: {},
                ro:{
                    xiangmuUuidNumber: true,
                    xiangmuName: false,
                    xiangmuTypes: false,
                    xiangmuJingfei: false,
                    xiangmuFile: false,
                    jiaoshiId: false,
                    xiangmuChuangxin: false,
                    xiangmuText: false,
                    xiangmuContent: false,
                    xiangmuYesnoTypes: false,
                    xiangmuYesnoText: false,
                    xiangmuDelete: false,
                    insertTime: false,
                },
                ruleForm: {
                ...
                rules: {
                   ...
                   xiangmuChuangxin: [
                              { required: true, message: '项目创新点不能为空', trigger: 'blur' },
                          ],
                   xiangmuText: [
                              { required: true, message: '项目实施方案不能为空', trigger: 'blur' },
                          ],
                   xiangmuContent: [
                   ...
                   xiangmuYesnoText: [
                              { required: true, message: '申报结果不能为空', trigger: 'blur' },
                          ],
                   xiangmuDelete: [
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=xiangmu_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.xiangmuYesnoTypesOptions = data.data.list;
                    }
                });
