               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="教师名称" prop="jiaoshiName">
                       <el-input v-model="ruleForm.jiaoshiName"
                                 placeholder="教师名称" clearable  :readonly="ro.jiaoshiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="教师邮箱" prop="jiaoshiEmail">
                       <el-input v-model="ruleForm.jiaoshiEmail"
                                 placeholder="教师邮箱" clearable  :readonly="ro.jiaoshiEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.jiaoshiTime"  class="input" label="入职时间" prop="jiaoshiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd"
                                v-model="ruleForm.jiaoshiTime"
                                type="date"
                                placeholder="入职时间"
                                :disabled="ro.jiaoshiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jiaoshiTime" label="入职时间" prop="jiaoshiTime">
                            <span v-html="ruleForm.jiaoshiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   jiaoshiEmail: [
                              { required: true, message: '教师邮箱不能为空', trigger: 'blur' },
